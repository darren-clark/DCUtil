namespace DCUtil.Task
{
    ...
    public static partial class TaskExtensions
    {
        ...
        private static Task<TResult> OnCompletionOuter<TResult, TContext>(this Task task, TContext context, Action<CompletionContext<TResult, TContext>> successAction, Action<Exception, CompletionContext<TResult, TContext>> faultedAction, Action<CompletionContext<TResult, TContext>> canceledAction, CancellationToken cancellationToken)
        {
            var tcs = new TaskCompletionSource<TResult>();
            task.OnCompletion(context, tcs, successAction, faultedAction, canceledAction, cancellationToken);
            return tcs.Task;
        }

        private static Task<TResult> OnCompletionOuter<TIn, TResult, TContext>(this Task<TIn> task, TContext context, Action<TIn, CompletionContext<TIn, TResult, TContext>> successAction, Action<Exception, CompletionContext<TIn, TResult, TContext>> faultedAction, Action<CompletionContext<TIn, TResult, TContext>> canceledAction, CancellationToken cancellationToken)
        {
            var tcs = new TaskCompletionSource<TResult>();
            task.OnCompletion(context, tcs, successAction, faultedAction, canceledAction, cancellationToken);
            return tcs.Task;
        ...
        {
            return task.OnCompletionOuter(context, completionAction, Continuations.Result<TResult>.Context<TContext>.DefaultFaulted, Continuations.Result<TResult>.Context<TContext>.DefaultCanceled, cancellationToken);
        }
        ...
        {
            return task.OnCompletionOuter(context, completionAction, Continuations.Result<TResult>.In<TIn>.Context<TContext>.DefaultFaulted, Continuations.Result<TResult>.In<TIn>.Context<TContext>.DefaultCanceled, cancellationToken);
        }
