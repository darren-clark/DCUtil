namespace DCUtil.Task
{
    ...
    public static partial class TaskExtensions
    {
        ...
        {
            return task.OnCompletionOuter(action, Continuations.FinallySuccess, Continuations.FinallyFaulted, Continuations.FinallyCanceled, CancellationToken.None);
        }

        public static Task Finally(this Task task, Func<Task> action)
        {
            return task.OnCompletionOuter(action, Continuations.FinallyTaskSuccess, Continuations.FinallyTaskFaulted, Continuations.FinallyTaskCancelled, CancellationToken.None);
        }

        public static Task<TResult> Finally<TResult>(this Task<TResult> task, Action action)
        {
            return task.OnCompletionOuter(action, Continuations.Result<TResult>.FinallySuccess, Continuations.Result<TResult>.FinallyFaulted, Continuations.Result<TResult>.FinallyCanceled, CancellationToken.None);
        }

        public static Task<TResult> Finally<TResult>(this Task<TResult> task, Func<Task> action)
        {
            return task.OnCompletionOuter(action, Continuations.Result<TResult>.FinallyTaskSuccess, Continuations.Result<TResult>.FinallyTaskFaulted, Continuations.Result<TResult>.FinallyTaskCancelled, CancellationToken.None);
        }
